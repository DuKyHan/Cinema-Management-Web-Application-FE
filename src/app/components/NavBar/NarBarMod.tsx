...
const pages = ['Cinemas', 'Films', 'Foods', 'News', 'Report'];
...
const navItems = [
  <NavItem
    ...
    name="Cinemas"
    icon={<TheatersIcon />}
    onClick={navigate => navigate(AppRoute.ModCinemaList)}
  />,
  <NavItem
    key={'films'}
    name="Films"
    icon={<MovieIcon />}
    onClick={navigate => navigate(AppRoute.ModCinemaFilmList)}
  />,
  <NavItem
    key={'foods'}
    name="Foods"
    icon={<EmojiFoodBeverageIcon />}
    onClick={navigate => navigate(AppRoute.ModFoodList)}
  />,
  <NavItem
    key={'news'}
    name="News"
    icon={<Newspaper />}
    onClick={navigate => navigate(AppRoute.ModNewsList)}
  />,
  <NavItem
    key={'reports'}
    name="Report"
    icon={<ReportProblemIcon />}
    onClick={navigate => navigate(AppRoute.Reports)}
  />,
];
